    ...
    <footer className="bg-zinc-950 py-12 px-4 border-t border-zinc-900 text-zinc-400 text-sm">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-6">
        ...
        <div className="flex flex-col items-center md:items-start">
          ...
          <span>CNPJ: {restaurante.cnpj}</span>
        </div>

        <div className="flex gap-6">
          <a href={restaurante.social.instagram} className="hover:text-primary transition-colors" aria-label="Instagram">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect width="20" height="20" x="2" y="2" rx="5" ry="5"/><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"/><line x1="17.5" x2="17.51" y1="6.5" y2="6.5"/></svg>
          </a>
          <a href={restaurante.social.facebook} className="hover:text-primary transition-colors" aria-label="Facebook">
